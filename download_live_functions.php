...
if (!empty($matches[1])) {
    $current_content = html_entity_decode($matches[1], ENT_QUOTES, 'UTF-8');
    file_put_contents(__DIR__ . '/live_functions.php', $current_content);
    echo "SUCCESS: Saved to live_functions.php\n";
} else {
    echo "Failed to retrieve functions.php content.";
}
