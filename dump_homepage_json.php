...
$trigger_url = 'https://khumairasnack.store/?dump_homepage_json=1';
...
add_action("init", function() {
    if (isset($_GET["dump_homepage_json"])) {
        header("Content-Type: text/plain");
...
// Write locally
file_put_contents(__DIR__ . '/homepage_elementor.json', $res);
echo "DUMPED homepage_elementor.json (" . strlen($res) . " bytes)\n";
